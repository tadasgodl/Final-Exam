...
class InstallController
{
    public function install()
    {
        ...
        App::$db->insertRow('users', ['name' => 'Zenadija', 'surname' => 'Tomasevic', 'email' => 'user3@user.com', 'phone' => '', 'address' => '', 'password' => 'user3']);
        ...
        App::$db->insertRow('feedback', ['user_id' => 2, 'date' => 1608710685, 'comment' => 'żaden polski trener, nie lubił']);
    }
}
